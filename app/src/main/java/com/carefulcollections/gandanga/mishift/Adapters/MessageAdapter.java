...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MyViewHolder> {
    ...
    ArrayList<Message> comments_list;
    ...
    public MessageAdapter(List<Message> posts_list, Context ctx) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final Message comment = comments.get(position);
        holder.article_text.setText(comment.message_text);
        ...
        try {
            ...
            if (!comment.user_picture_url.equals("none")) {
                Glide.with(ctx.getApplicationContext()).load(url+ comment.message_picture_url)
                ...
                holder.comment_image.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("picture_url", comment.message_picture_url);
