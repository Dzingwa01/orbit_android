...
import com.carefulcollections.gandanga.mishift.HomeActivity;
import com.carefulcollections.gandanga.mishift.EmployeesManager.InboxFragment;
import com.carefulcollections.gandanga.mishift.LoginActivity;
...
import com.carefulcollections.gandanga.mishift.Helpers.ViewPagerAdapter;
...
//            id_number = pref.id_number;
        ...
        if (merlinsBeard.isConnected()) {
            ...
            Toast.makeText(this,"Yo are not connected to the internet my nigger",Toast.LENGTH_LONG);
        }
    }
    @Override
