...
import com.carefulcollections.gandanga.mishift.EmployeesManager.SwapOfferActivity;
...
public class ManagerShiftDetails extends AppCompatActivity {
...
//            post_list = new ArrayList<Post>();
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                showProgress(true);
                RequestQueue requestQueue = Volley.newRequestQueue(ManagerShiftDetails.this);
...
//
                                ...
                                Toast.makeText(ManagerShiftDetails.this, "There are no team members on this shifts", Toast.LENGTH_LONG).show();
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                ...
                showProgress(false);
                Toast.makeText(ManagerShiftDetails.this, e.getMessage(), Toast.LENGTH_LONG).show();
            }
