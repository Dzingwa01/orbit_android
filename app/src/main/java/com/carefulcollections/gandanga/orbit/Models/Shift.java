...
public class Shift {
    ...
    public  Shift(String shift_title,Date start_date, Date end_date,Date shift_date,int shift_duration, String team_name,String start_time, String end_time,String shift_description){
