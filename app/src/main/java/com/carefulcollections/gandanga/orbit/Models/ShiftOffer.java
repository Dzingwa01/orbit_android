...
public class ShiftOffer {
    ...
    public ShiftOffer(int id, int offer_shift, int team_member,int employee_id,String reason, Boolean approval,String created_at,String shift_date,String name, String surname){
        this.id = id;
